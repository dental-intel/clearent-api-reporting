...
namespace ClearentReportingApi;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://reporting-sb.clearent.net';
    ...
    {
        $report  = 'PHP SDK (ClearentReportingApi) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://reporting-sb.clearent.net",
                "description" => "No description provided",
            ],
            [
                "url" => "https://reporting.clearent.net",
                "description" => "No description provided",
            ]
        ];
    }
